...
$string['emailonlyallowed'] = 'Este endereço de e-mail não é permitido ({$a})';
$string['emailpasswordchangeinfo'] = 'Oi {$a->firstname},

Alguém (provavelmente você) solicitou uma nova senha para sua
conta "{$a->username}" em "{$a->sitename}".

Para alterar sua senha, vá para o seguinte endereço da web:

{$a->link}

Na maioria dos programas de e-mail, isso deve aparecer como um link azul
que você pode clicar. Se isso não funcionar,
então recorte e cole o endereço na linha de endereço
no topo da janela do seu navegador da web.
...
$string['resetinfo'] = 'Excluir todos os dados do usuário e redefinir este curso para seu estado inicial, mantendo sem alteração suas atividades e configurações.';
