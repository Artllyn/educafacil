...
$string['editingordering'] = 'Editando pergunta de ordenação';
...
$string['notenoughanswers'] = 'As perguntas de ordenação devem ter mais de {$a} respostas.';
...
$string['numberingstyle_help'] = 'Escolha o estilo de numeração para os itens arrastáveis nesta pergunta.';
