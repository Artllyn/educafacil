...
class __Mustache_8a459fb487f51f40dd2ba7405d655ea3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section478f8136509b7cc96122c88d4243fd47($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section7668f605734b9cbc54a79de25fd0f63b($context, $indent, $value);
        $value = $context->find('controlmenu');
        $buffer .= $this->sectionA05a9efa8a6615cafc2b7d6f99aac760($context, $indent, $value);
        $value = $context->find('header');
        $buffer .= $this->sectionD3853bb67b8e2db0912bdcae997d991a($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section478f8136509b7cc96122c88d4243fd47(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7668f605734b9cbc54a79de25fd0f63b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section90b7e79ec59f18b9c24cf535a2367d96(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionD3853bb67b8e2db0912bdcae997d991a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section90b7e79ec59f18b9c24cf535a2367d96($context, $indent, $value);
                $context->pop();
            }
        }
